...
import com.tutorial.ecommerce.api.controller.auth.model.LoginBody;
import com.tutorial.ecommerce.api.controller.auth.model.RegistrationBody;
...
public class UserService {
    ...
    public String loginUser(LoginBody loginBody) throws UserNotVerifiedException, EmailFailureException {
        Optional<Object> opUser = localUserDAO.findByUsernameIgnoreCase(loginBody.getUsername());
        if (opUser.isPresent()) {
